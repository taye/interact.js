...
declare const autoScroll: {
    ...
    now: () => number;
    interaction: import("../types").Interaction<any>;
    i: number;
    x: number;
    y: number;
    isScrolling: boolean;
    ...
    margin: number;
    speed: number;
    start(interaction: import("../types").Interaction<any>): void;
    stop(): void;
    scroll(): void;
    ...
    onInteractionMove<T extends "resize" | "drag" | "drop" | "gesture">({ interaction, pointer }: {
        interaction: import("../types").Interaction<T>;
        pointer: import("../types").PointerType;
    }): void;
};
