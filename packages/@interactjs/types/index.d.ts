...
declare module "@interactjs/utils/domUtils" {
    import * as Interact from "@interactjs/types/index";
    export function nodeContains(parent: Node | Interact.EventTarget, child: Node | Interact.EventTarget): boolean;
    ...
    export function matchesSelector(element: Interact.Element, selector: string): any;
    export function indexOfDeepestElement(elements: Interact.Element[] | NodeListOf<Element>): number;
    export function matchesUpTo(element: Interact.Element, selector: string, limit: Node): any;
...
declare module "@interactjs/utils/rect" {
    import * as Interact from "@interactjs/types/index";
    export function getStringOptionResult(value: any, target: Interact.HasGetRect, element: any): (Node & ParentNode) | Interact.Rect;
...
declare module "@interactjs/utils/misc" {
    ...
    export function copyAction(dest: Interact.ActionProps, src: Interact.ActionProps): Interact.ActionProps<any>;
}
...
declare module "@interactjs/utils/pointerUtils" {
    ...
    export function getEventTargets(event: any): Interact.Element[];
