...
(function (f) {
  ...
  _$getOriginXY_68.default = getOriginXY;
  ...
  function getDrop(_ref7, dragEvent, pointerEvent) {
    ...
    for (var _i5 = 0; _i5 < dropState.activeDrops.length; _i5++) {
      ...
      if (_dropzone3.dropCheck(dragEvent, pointerEvent, draggable, dragElement, dropzoneElement, _rect)) {
  ...
  var Modification = /*#__PURE__*/function () {
    function Modification(interaction) {
      ...
      ___defineProperty_33(this, "startEdges", void 0);
    ...
    ___createClass_33(Modification, [{
      ...
      value: function start(_ref, pageCoords) {
        ...
        this.startEdges = (0, _$extend_67.default)({}, interaction.edges);
        this.edges = (0, _$extend_67.default)({}, this.startEdges);
      ...
      value: function setAll(arg) {
        ...
        arg.edges = (0, _$extend_67.default)({}, unmodifiedEdges);
        ...
        (0, _$extend_67.default)(this.edges, arg.edges);
      ...
      value: function rectChecker(checker) {
        ...
        if (_$is_70.default.func(checker)) {
          this.getRect = function (element) {
            var rect = (0, _$extend_67.default)({}, checker.apply(_this, element));
  ...
  var aspectRatio = {
    start: function start(arg) {
      ...
      if (enabled !== false) {
        (0, _$extend_67.default)(edges, linkedEdges);
      }
