...
declare module "@interactjs/pointer-events/PointerEvent" {
    ...
    export default class PointerEvent<T extends string = any> extends BaseEvent {
        ...
        [key: string]: any;
        /** */
        constructor(type: T, pointer: Interact.PointerType | PointerEvent<any>, event: Interact.PointerEventType, eventTarget: Node, interaction: Interact.Interaction, timeStamp: number);
...
declare module "@interactjs/auto-start/hold" {
    ...
    function install(scope: Interact.Scope): void;
    function getHoldDuration(interaction: Interact.Interaction): any;
    const _default_8: {
        id: string;
        install: typeof install;
        listeners: {
