...
test('Interactable copies and extends defaults', t => {
  ...
  t.deepEqual(
    interactable.options.test.fromDefault,
    defaults.actions.test.fromDefault,
  ...
  t.notOk(
    'c' in interactable.options.test.fromDefault,
...
test('Interactable copies and extends per action defaults', t => {
  ...
  t.notOk(
    'c' in (interactable.options as any).test.testOption.fromDefault,
    'modifying defaults does not affect constructed interactables',
  )
