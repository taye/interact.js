...
export declare class Scope {
    ...
    events: {
        ...
        removeDelegate: (selector: string, context: Document | HTMLElement | SVGElement, type: string, listener?: (event: Event | import("../utils/events").FakeEvent) => any, optionalArg?: any) => void;
